...
ALLOWED_LINE_STYLES = ['solid', 'dashed', 'dashed_uneven', 'dashed_square', 'dashed_outline', 'dense_thin', 'dense_thick', 'dotted_dense', 'dotted', 'dotted_outline', 'densedot_outline', 'hollow', 'hollow_open']
